...
class DetectionModelHelper(cnn.CNNModelHelper):
    ...
    def TrainableParams(self, gpu_id=-1):
        ...
        return [
            ...
            if (p in self.param_to_grad and  # p has a gradient
        ...
        if cfg[cfg_key].GENERATE_PROPOSALS_ON_GPU:
            ...
            for i in range(cfg.NUM_GPUS):
                with c2_utils.CudaScope(i):
                    workspace.FeedBlob('gpu_{}/{}'.format(i, anchors_name),
    ...
    def ConvShared(self,
        ...
        """
        use_bias = (False if
                    ('no_bias' in kwargs and kwargs['no_bias']) else True)
    ...
    def BilinearInterpolation(self, blob_in, blob_out, dim_in, dim_out,
        ...
        blob = self.ConvTranspose(blob_in,
                                  blob_out,
                                  dim_in,
                                  dim_out,
                                  kernel_size,
