...
def add_single_gpu_param_update_ops(model, gpu_id):
    if cfg.WSL.ITER_SIZE == 1:
        import detectron.modeling.optimizer as optim
        optim.add_single_gpu_param_update_ops(model, gpu_id)
        return
    ...
    for param in model.TrainableParams(gpu_id=gpu_id):
        ...
        param_acmgrad = model.param_init_net.ConstantFill([param],
                                                          param + '_acmgrad',
                                                          value=0.0)
