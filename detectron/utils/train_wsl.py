...
from detectron.datasets.roidb_wsl import combined_roidb_for_training
from detectron.modeling import model_builder_wsl
from detectron.utils import lr_policy
from detectron.utils.training_stats_wsl import TrainingStats
import detectron.utils.env as envu
import detectron.utils.net as nu
import detectron.utils.debug as debug
import detectron.utils.cpg_utils as cpg_utils
import detectron.utils.db_vis as db_vis
import detectron.utils.webly_vis as webly_vis
import detectron.utils.cpg_vis as cpg_vis
import detectron.utils.cpg_stats as cpg_stats
...
def train_model():
    ...
    for cur_iter in range(start_iter, cfg.SOLVER.MAX_ITER):
        ...
        #     webly_vis.vis_training(cur_iter)
        # else:
        #     cpg_vis.vis_training(cur_iter)
        if False:
            db_vis.vis_training(cur_iter)
